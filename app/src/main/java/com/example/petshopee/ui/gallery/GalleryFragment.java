package com.example.petshopee.ui.gallery;
...
import com.example.petshopee.databinding.FragmentGalleryBinding;
...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        recyclerView = v.findViewById(R.id.recyclerViewCats);
        setUpRecyclerView();
        return v;
    }
    private void setUpRecyclerView() {

        Query query = db.collection("Cats").orderBy("petName", Query.Direction.ASCENDING);
