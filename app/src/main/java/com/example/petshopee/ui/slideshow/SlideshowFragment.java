package com.example.petshopee.ui.slideshow;
...
import com.example.petshopee.databinding.FragmentSlideshowBinding;
...
public class SlideshowFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        recyclerView = v.findViewById(R.id.recyclerViewBirds);
        setUpRecyclerView();
        return v;
    ...
    private void setUpRecyclerView() {
        ...
        Query query = db.collection("Birds").orderBy("petName", Query.Direction.ASCENDING);
